...
Tailwind CSS v4 · shadcn/ui (New York, Radix UI, Lucide) · Vite 7 ·
...
| Never add duplicate Vite plugins            | Vite plugins are already configured in `vite.config.ts` (React, Tailwind, Cloudflare, tsconfig paths, TanStack Start) — duplicates break the build |
