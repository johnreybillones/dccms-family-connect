    ...
    <PublicLayout>
      ...
      <section className="bg-sky py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-10 items-center">
          <div className="text-white">
            <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4 drop-shadow">
              About Our Day Care Center
            </h2>
      ...
      <section className="bg-sky pb-20">
        <div className="mx-auto max-w-7xl px-6">
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-white text-center mb-10 drop-shadow">
            Our Programs
          </h2>
            ...
            {programs.map((p) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <h3 className="font-display text-2xl text-brand font-bold mb-2">{p.title}</h3>
