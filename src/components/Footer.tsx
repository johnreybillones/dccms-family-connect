...
const linkCls = "text-sm text-foreground/70 hover:text-brand transition-colors";
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <div className="flex gap-3 text-foreground/80">
            ...
            <a href="#" aria-label="X / Twitter" className="hover:text-brand">
              <Twitter size={18} />
            </a>
        ...
        <div className={col}>
          ...
          <Link to="/announcements" className={linkCls}>
            Announcements
          </Link>
        ...
        <div className={col}>
          <h3 className={heading}>Day Care Center</h3>
          <Link to="/about" className={linkCls}>
            Our Mission
          </Link>
          <Link to="/about" className={linkCls}>
        ...
        <div className={col}>
          ...
          <span className="text-sm text-foreground/70">Day Care Personnel</span>
          <span className="text-sm text-foreground/70">Barangay San Antonio de Padua I</span>
          <span className="text-sm text-foreground/70">Parents &amp; Guardians</span>
          <span className="text-sm text-foreground/70">CSWD Office</span>
        </div>
      </div>
      <div className="border-t border-sky-100 py-4 text-center text-xs text-foreground/60">
        © {new Date().getFullYear()} Barangay San Antonio de Padua I Day Care Center · Dasmariñas
        City, Cavite
      </div>
    </footer>
  );
